...
class TSChatEmotionInputView: UIView {
    ...
    override func awakeFromNib() {
        ...
        self.listCollectionView.register(TSChatEmotionCell.ts_Nib(), forCellWithReuseIdentifier: "TSChatEmotionCell")
        self.listCollectionView.isPagingEnabled = true
        self.listCollectionView.emotionScrollDelegate = self

        //init dataSource
        guard let emojiArray = NSArray(contentsOfFile: Bundle.main.path(forResource: "Expression", ofType: "plist")!) else {
            return
        }
...
extension TSChatEmotionInputView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "TSChatEmotionCell", for: indexPath) as! TSChatEmotionCell
